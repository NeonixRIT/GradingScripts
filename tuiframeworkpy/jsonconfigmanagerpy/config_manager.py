...
class ConfigManager():
    __slots__ = ['config_path', 'config', 'config_entries', 'path_entries', 'censored_entries', 'default_config_dict', 'friendly_names_dict', 'name_to_entry', 'custom_verify_methods', 'on_config_change', 'on_config_save', 'on_config_read', 'on_config_verify']
