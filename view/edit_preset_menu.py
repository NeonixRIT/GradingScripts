...
class EditPresetMenu(SubMenu):
    ...
    def __init__(self, context, id, preset_name):
        ...
        edit_suffix = MenuOption(
            2,
            f'File Suffix: {self.preset[1]}',
            edit_suffix_event,
            Event(),
            Event(),
            False,
        ...
        edit_app_time = MenuOption(
            5,
            f'Append Time: {self.preset[4]}',
            edit_app_time_event,
            Event(),
            Event(),
            False,
        ...
        SubMenu.__init__(
            self,
            id,
            f'Manage Preset: {CYAN}{preset_name}{WHITE}',
            self.local_options,
            Event(),
            Event(),
        )
