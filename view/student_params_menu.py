    ...
    def edit_param(self, student_param):
        while True:
            ...
            name_option = MenuOption(
                ...
                lambda student_param=student_param: self.edit_param_value(student_param, 'name'),
                Event(),
                Event(),
                False,
                False,
            ...
            github_option = MenuOption(
                ...
                lambda student_param=student_param: self.edit_param_value(student_param, 'github'),
                Event(),
                Event(),
                False,
                False,
            ...
            extra_ca_option = MenuOption(
                ...
                lambda student_param=student_param: self.edit_param_value(student_param, 'class_activity_adj'),
                Event(),
                Event(),
                False,
            )
            ...
            extra_as_option = MenuOption(
                ...
                lambda student_param=student_param: self.edit_param_value(student_param, 'assignment_adj'),
                Event(),
                Event(),
                False,
            )
            ...
            extra_ex_option = MenuOption(
                ...
                lambda student_param=student_param: self.edit_param_value(student_param, 'exam_adj'),
                Event(),
                Event(),
                False,
            )
