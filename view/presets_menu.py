...
class PresetsMenu(SubMenu):
    ...
    def __init__(self, id):
        ...
        add_preset = MenuOption(
            1, 'Create New Preset', add_preset_event, Event(), Event()
        )
    ...
    def build_preset_options(self):
        ...
        for i, preset in enumerate(
            ...
            option = MenuOption(
                i + 1, preset.name, option_event, Event(), Event(), False
            )
    ...
    def create_preset(self):
        ...
        append_timestamp = bool_prompt(
            'Would you like to append timestamp to the folder name?', False
        )
